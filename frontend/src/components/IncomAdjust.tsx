...
import { Grid, Container, Modal, ListItem, ListItemText, Table, TableBody, TableCell, TableHead, TableRow } from '@material-ui/core';
...
const IncomAdjust = (props: Props) => {
    ...
    const { register, watch, handleSubmit, formState: { errors }, control } = useForm<IncomAdjustDatas>({
        mode: 'onSubmit',
                    ...
                    <Container fixed>
                        ...
                        <form onSubmit={handleSubmit(handleOnSubmit, handleOnError)} className={classes.root} noValidate autoComplete="off">
                            ...
                            <Grid container spacing={1}>
                                ...
                                <Grid item xs={12}>
                                    <Controller
                                        render={({ field }) => <TextField label="生年月日" {...field} />}
                                        name="dependentsBD"
                                        control={control}
                                    />
